            ...
            <?php
                ...
                <form method="post" action="">
                    <table colspan="2" align="center">
                        ...
                        <tr>
                            <td>Task Name</td>
                            <td><input type="text" name="task_name" value="<?php echo $row->task_name; ?>"> </td>
                        </tr>
                        <tr>
                            <td>Task Details</td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="task_assigned_from" value="<?php echo $row->task_assigned_from; ?>"> </td>
                        </tr>
                        <tr>
                            <td>Task Assigned To</td>
                            <td><input type="number" name="task_assigned_to" value="<?php echo $row->task_assigned_to; ?>"> </td>
                        </tr>
                        <tr>
                        ...
                        <td colspan="1" align="center"><input type="submit" name="update" value="Task Update"></td>
                        </tr>
                    </table>
                </form>
                <?php
